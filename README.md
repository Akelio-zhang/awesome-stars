...
- [dengzii/glide-im](https://github.com/dengzii/glide-im) - glide instant-messaging service
...
- [Emericen/tiny-qwen](https://github.com/Emericen/tiny-qwen) - A minimal PyTorch re-implementation of Qwen 3.8
...
- [mizorewww/course2md](https://github.com/mizorewww/course2md) - Turn YouTube, Bilibili, or local course/meeting recordings into slide-illustrated Markdown and HTML lecture notes.
...
- [AkimioJR/AutoFilm](https://github.com/AkimioJR/AutoFilm) - 一个为Emby、Jellyfin提供生成strm、动漫追番、绘制媒体库海报的小工具
...
- [skyzh/write-you-a-vector-db](https://github.com/skyzh/write-you-a-vector-db) - build vector database extensions over Apache Datafusion and/or CMU-DB's BusTub system
