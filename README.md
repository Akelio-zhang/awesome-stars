...
- [skyzh/vector-db-from-scratch](https://github.com/skyzh/vector-db-from-scratch) - Learn vector search with Rust and DataFusion; the C++/BusTub track is deprecated.
